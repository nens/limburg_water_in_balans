...
echo "FRICTION: download via de citybuilder"
DIT NOG INVULLEN
    gdal_calc.py -A input/landgebruik/*.tif --NoDataValue -9999 --outfile=output/friction/friction.tif --calc="(A==1)*0.058+(A==2)*etc." --co COMPRESS=DEFLATE 
