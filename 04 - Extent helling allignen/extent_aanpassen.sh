...
# bijvoorbeeld aanroepen als volgt: C:\Users\stan.vandenbosch\Documents\Q0156\algemeen_script>sh extent_aanpassen.sh dem.tif interceptie.tif 1 interceptie_nieuw.tif
...
# Werkt alleen op Linux/via Putty
# sh extent_aanpassen.sh [extentraster] [inputraster] [aannamewaarde] [outputraster]
...
#----------------------------SCRIPT--------------------------------------------------
echo "extentraster  :" $1 # input; output krijgt deze extent en vorm
echo "inputraster   :" $2 # input; het raster dat aangepast wordt
echo "aannamewaarde :" $3 # aannamewaarde indien raster geen waarde heeft
echo "outputraster  :" $4 # outputraster
echo "
...
---" # BATCH 2
gdal_calc.py --NoDataValue -9999 -A $1 --outfile enenraster_ongec.tif --calc="1" # BATCH 2

echo "---
VULRASTER MAKEN (RASTER MET AANNAMEWAARDE DIE INGEVULD WORDT ALS INPUTRASTER GEEN WAARDE HEEFT
---"
gdal_calc.py --NoDataValue -9999 -A $1 --outfile vulraster_ongec.tif --calc="$3"
...
---"
gdal_calc.py --NoDataValue -9999 -A enenraster_ongec.tif -B vulraster_ongec.tif --outfile outputraster_ongec.tif --calc="A*B"
