...
SIMULATION_START = datetime(2022, 9, 28, 18, 0).astimezone(AMSTERDAM)
...
def start_simulatie(
    ...
    simulation = THREEDI_API.simulations_from_template(
        data={
            ...
            "tags": ["Waterschap Limburg", "Stikstof", schematisation_name],
    ...
    if bui == "T25":
        ...
        raise ValueError("Kies 'T25' of 'T100' als bui")
...
if __name__ == "__main__":
    for schem_name in ["Geul_Midden"]:
        for bui in ["T100"]:
            for scenario in ["25p","50p","75p"]:
                schem = schem_name + ' ' + bui + ' ' + scenario
                print(schem)
