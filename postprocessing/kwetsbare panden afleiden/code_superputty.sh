...
ogr2ogr -overwrite -f "PostgreSQL" PG:"host=utr-gis-db-01 user=postgis dbname=x0143_stikstof password=postgis port=5432" -nln deelgebied shapefiles_deelgebieden/bounding_box.shp -a_srs EPSG:28992 -lco GEOMETRY_NAME=geom -lco precision=NO

psql -h utr-gis-db-01 -p 5432 -U postgis -d x0143_stikstof -f combineer_watervlakken_panden.sql
